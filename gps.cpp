...
bool gps::checkGpsFix()
{
  ...
  else
  {
    ...
    Serial.println(F(" sats visible"));

    // sprintf(t, sizeof(t), "location valid: %i" , tGps.location.isValid());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "location age: %i" , tGps.location.age());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "hdop valid: %i" , tGps.hdop.isValid());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "hdop age: %i" , tGps.hdop.age());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "hdop: %i" , tGps.hdop.value());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "altitude valid: %i" , tGps.altitude.isValid());
    // Serial.println(t);
    // sprintf(t, sizeof(t), "altitude age: %i" , tGps.altitude.age());
    // Serial.println(t);
